...
namespace gx
{
    ...
    inline void print(bool val) { std::printf(val ? "true" : "false"); }
    inline void print(int val) { std::printf("%d", val); }
    inline void print(float val) { std::printf("%g", val); }
    inline void print(double val) { std::printf("%f", val); }
    inline void print(const char *val) { std::printf("%s", val); }
    ...
    struct Array
    {
        ...
        const T &operator[](int i) const { return const_cast<Array &>(*this)[i]; }
    ...
    struct Slice
    {
        ...
        Slice(std::initializer_list<T> l) { copyFrom(l.begin(), l.size()); }
        ...
        const T &operator[](int i) const { return const_cast<Slice &>(*this)[i]; }
    ...
    struct String
    {
        ...
        String(const char *s) { slice.copyFrom(s, std::strlen(s) + 1); }

        operator const char *() const { return (const char *)slice.data; }
        ...
        auto begin() const { return slice.begin(); }

        auto end() const { return slice.end() - 1; }
    };

    inline int len(const String &s) { return s.slice.size - 1; }
    ...
    inline bool operator==(const String &a, const char *b) { return !std::strcmp(a, b); }
